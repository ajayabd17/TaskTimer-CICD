pipeline {
        ...
        stage('Blue-Green Deploy') {
            steps {
                script {
                    ...
                    // WINDOWS-SAFE: No || — Use if errorlevel 1
                    bat '''
                    ...
                    def deleteCmd = "kubectl delete deployment tasktimer-${current} --ignore-not-found"
    ...
    post {
        success {
            echo 'Deployment successful on Windows Jenkins Agent!'
        }
        failure {
